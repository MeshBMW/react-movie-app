...
function Wrapper({
  searchTerm, setSearchTerm, isLoading, errorMessage, isSearchMode, isSearching,
  searchResultsList, trendingAll, popularMovies, popularTV, trendingSearches, inputRef
 }) {
  return (
